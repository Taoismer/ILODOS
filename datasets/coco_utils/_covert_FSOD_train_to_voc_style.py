...
cate_frame.to_csv(os.path.join(csv_path, 'train_category.csv'))
...
target_folder = '/home/causal_ws/OWOD/datasets/coco_utils/ImageSets/FSOD/train'
if not os.path.isdir(target_folder):
    os.mkdir(target_folder)

id_txt = os.path.join(target_folder, 'train.txt')
selected_ids = []
