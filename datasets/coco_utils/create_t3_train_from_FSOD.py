...
IDS = IDS[300:600] # start from id 1
print(max(IDS))
...
target_folder = '/home/causal_ws/OWOD/datasets/coco_utils/ImageSets/t3'
...
id_txt = os.path.join(target_folder,'t3_train_fsod.txt')
cate_txt = os.path.join(target_folder,'t3_train_cate_fsod.txt')
