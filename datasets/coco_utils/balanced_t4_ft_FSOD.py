...
known_classes = VOC_CLASS_NAMES + T4_CLASS_NAMES 
train_files = ['./ImageSets/t4/t4_train_fsod.txt','../VOC2007/ImageSets/Main/t1_train.txt']

# known_classes = list(itertools.chain(VOC_CLASS_NAMES))
annotation_location = '/home/causal_ws/OWOD/datasets/VOC2007/Annotations'

items_per_class = 1
dest_file = './ImageSets/t4/t4_ft_fsod_' + str(items_per_class) + '.txt'
